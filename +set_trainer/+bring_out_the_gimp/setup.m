...
%  PLDAPS SETUP FILE
%  PACKAGE:  set_trainer
%  TRIAL FUNCTION:  bring_out_the_gimp

%  Set trial master function
p.trial.pldaps.trialFunction = 'set_trainer.bring_out_the_gimp.bring_out_the_gimp';
...
p.trial.temp.features.symbol.linewidth = 15;
...
%[training_set,training_noset] = set_generator({'B','S','P'},{'O','Y','G'},{'C','S','T'});
[training_set,training_noset] = set_generator({'A','K'},{'K','A'},{'S'},'mask-training');
