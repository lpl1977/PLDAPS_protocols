function p = stairway_to_heaven(p,state)
%p = stairway_to_heaven(p,state)
%
%  PLDAPS trial function for set game training aka stairway_to_heaven
...
switch state
    ...
    case p.trial.pldaps.trialStates.trialSetup
        ...
        feval(str2func(strcat('set_trainer.stairway_to_heaven.',p.trial.session.subject)),p);
