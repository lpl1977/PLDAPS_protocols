function p = setup(p)
%PLDAPS setup file for ready_set_go

%  Set trial master function
p.trial.pldaps.trialFunction = 'set_trainer.ready_set_go.ready_set_go';

%  Load the joystick calibration file
p.trial.joystick.beta = getfield(load('joystick_calibration','beta'),'beta');
